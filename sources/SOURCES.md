...
says so. Two were abstract-only (Pashler 2008, Rozenblit and Keil 2002); both were extended to the body
from PDFs Harsh supplied, 2026-09-25 (see the group b section below).
...
| `pashler_2008_learning_styles.txt` | Pashler et al., *PSPI* 2008;9(3):105-119 (PDF prints © 2009 APS). Article PDF supplied by Harsh (pdftotext; ligatures as extracted) + USF record abstract. Publisher copyright. **Whole body; figure panels, acknowledgments and references not held** | 12,457 | Meshing hypothesis; the style-by-method crossover criterion (learning style on the x-axis); Fig. 1 caption and in-figure text: acceptable A-C, unacceptable D-I; Fig. 2 caption (crossover with method on the x-axis does not count); one arguable study (Sternberg 1999: 112 of 324 classified); Massa & Mayer 2006, Cook et al. 2009 (123 residents), Constantinidou & Baker 2002 negative; ATI studies; "no adequate evidence base" |
| `rozenblit_keil_2002_ioed.txt` | Rozenblit and Keil, *Cogn Sci* 2002;26:521 (PMC3062901, author manuscript NIHMS268518). Manuscript PDF supplied by Harsh (pdftotext) + efetch abstract. © Cognitive Science Society. **Title through General discussion; Fig. captions; Table 8. Tables 1-7, appendices, references not held** | 18,325 | 7-point scale; T1 rate, T2 after writing a step-by-step causal explanation, T3 after a diagnostic question, T4 after an expert explanation, T5 current; drop T1 to T2-T4 (Study 1: 16 graduate students, F(4, 56) = 16.195, p < .001; Study 2: 33 undergraduates, F(4, 124) = 38.9); smaller drop for facts, none for procedures or narratives; warning reduces but does not remove it; visible parts predict overconfidence. Means are plotted, not printed |
...
## Added by the S57-R1 source intake, group b (statistics, teaching guides, assessment, leadership), 2026-09-24/25
...
| `stoller_2020_leadership.txt` | Stoller, *Chest* 2021;159:1147 (PMC7501065). © ACCP/Elsevier, PMC COVID-19 permission. **Excerpts.** Filed as the open substitute for Kotter 1990 before Kotter was obtained (now `kotter_1990_what_leaders_do.txt`) | 1,171 | Table 1 "Attributes of Managing vs Leading", "After Kotter": planning and budgeting / organizing and staffing / controlling and solving vs vision and setting direction / aligning people / motivating and inspiring; "leadership competencies can be developed"; "small l" and "big L" leadership |

Added 2026-09-24/25 by the S57-R1 intake (group b). Kotter 1990 and the full texts of Hake 1998 and Biggs 1996 were not obtained; see `books/S57-R1/intake/log-b.md`.

Added 2026-09-25 from a PDF Harsh supplied (logged in `books/S57-R1/INTAKE.md`, "Harsh's PDFs"); Pashler 2008 and Rozenblit and Keil 2002 above were extended from his PDFs the same day. Verbatim check 29 of 29 across the three files.

| File | What it is | Words | Verified in it |
| --- | --- | --- | --- |
| `kotter_1990_what_leaders_do.txt` | Kotter, *Harv Bus Rev* 1990, text of the Best of HBR reprint (Dec 2001, R0111F), PDF supplied by Harsh (pdftotext; ligatures as extracted). "COPYRIGHT © 2001 HARVARD BUSINESS SCHOOL PUBLISHING CORPORATION. ALL RIGHTS RESERVED." Held for private study and quotation only. **Whole article** | 7,365 | Management copes with complexity, leadership with change; planning and budgeting vs setting a direction; organizing and staffing vs aligning people; controlling and problem solving vs motivating and inspiring; "overmanaged and underled"; informal networks; developing leaders (early challenge, broadening); Kodak, AmEx and P&G boxes with their figures |
Extended the same day: `openstax_intro_stats_2e.txt` (§1.4 appended); its row in the Book 0 Part D section is updated.

## Added by the S57-R1 source intake, group c (Indian medical-education instruments), 2026-09-24/25
