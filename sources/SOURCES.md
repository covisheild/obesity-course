...
| `food_corporations_act_1964.txt` | Food Corporations Act 1964 (Act 37 of 1964), India Code section records, ss.3 and 13 | 612 | s.3(1)-(2) establishment of the Food Corporation of India as a body corporate; s.13(1) primary duty to undertake purchase, storage, movement, transport, distribution and sale of foodgrains and other foodstuffs; s.13(2) further functions with Central Government approval |
| `eca_1955.txt` | Essential Commodities Act 1955 (Act 10 of 1955), India Code section records, ss.2A and 3 | 4,018 | s.2A essential commodity means a commodity in the Schedule, Centre may add or remove; s.3(1) power to regulate or prohibit production, supply, distribution, trade; s.3(2)(c) controlling price, (d) regulating storage, distribution, (f) requiring stockholders to sell; s.3(3B)(d) names the Agricultural Prices Commission; s.3(3C) fair and remunerative price for sugarcane; no s.3(1A) in the text held |
