...
About 61.3, not past 70. The note is not wrong about its arithmetic. It is wrong about which
...
extra unit of a dose works the same way, and every word of this section applies to it.
...
- Where gains are slowing, an average over the whole programme is the number most flattering to it.
