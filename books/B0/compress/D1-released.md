...
**Where this picture breaks.** Every probability above is a ceiling, not a measurement. The Act bounds how far the entitlement can
...
- Every probability, complement and odds you compute from a ceiling is itself a ceiling. Say so in the same sentence you quote the number, or the reader will treat it as a count.
