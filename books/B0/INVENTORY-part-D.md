...
| D7 | `C30` Random error and systematic error as different things | D6, D5, A3, B1 | Error is a measured value minus a true one; systematic error pushes every reading the same way and averaging does not remove it; random error scatters and averaging does; accuracy, trueness, precision and resolution as the VIM defines them | 10–12 | VIM3 entries; Kiran 2022's scale "with accuracy of 100 g", and its single observer |
