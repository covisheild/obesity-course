...
**In plain terms.** A rate of change is a change divided by the time it took. Take the quantity at the start. Take it
...
For a curve they come apart. A curve is steep in some places and nearly flat in others. An average
across the whole of it can sit far from its steepness at both ends.

Somewhere in between, though, the curve is exactly as steep as the average. It has to be. A curve
that stayed steeper than the average all the way across would finish higher than it does. One that
stayed flatter would finish lower. So the steepness passes through the average on the way. What
the average will not tell you is where it passed. Nor will it tell you how far the curve got from
the average on either side of that point.

Here is how you get each one off a drawn curve, with a ruler.

For the average rate between two points, lay the ruler across those two points. The line you have
laid down has a name: it is a chord.

For the rate at one point, lay the ruler so that it touches the curve at that point and runs along
it. Read its slope the same way. That touching line has a name too: it is a tangent.

A shorter interval gives you a closer answer. Take the average over a month and you get the month.
Take it over a day around the same moment and you get much nearer to the moment itself.
...
Last, run the unit check from the section on dimensional analysis before you believe any rate. A
quantity in kilograms, changing over months, gives a rate in kilograms per month. If somebody
...
Count the time before you divide. Six readings a month apart span five months, not six. Each
month runs from one reading to the next, so the intervals are always one fewer than the
readings.
...
About 9.22 a month. That number is the average rate of change over the five months, and it is
correct.
...
No single month ran at 9.22. The average is a true statement about the five months together and
a false statement about any one of them.
...
About 61.3, not past 70. Even 61.3 is too high if the rate keeps falling, as it has every month
so far. So treat it as an upper bound, not a forecast. The section before this one puts this
column's ceiling at 60, if the ratio between its steps keeps holding.

The note is not wrong about its arithmetic. It is wrong about which interval its arithmetic
describes.
...
**Where this picture breaks.** The six values in the first table are bare numbers.

An average rate over an interval is exact for that interval.

A quantity measured once a month has no rate you can check between the measurements.

And time is not the only thing a quantity can change against. The grain a household is counted
for changes against the number of people in it, at five kilograms a month for each extra
person. Put people along the bottom and that is a slope. The chord, the tangent and the unit
check carry over. The grain is in kilograms a month, so the slope is in kilograms a month per
person: "per person" is added and "per month" stays. A dose along the bottom and a measured
effect up the side works the same way.

**Figure.** One curve and three averages. Each straight line runs to the last reading from a different starting point, and each average is the slope of its own line: 9.22 a month taken over five months, 3.45 a month taken over the last two, 2.60 a month taken over the last one. Every one of the three is an average and none of them is the rate at a moment, which six monthly readings cannot give you.

*What the figure shows:* A curve rising steeply and then flattening, with a reading marked at each of six months. Three straight lines are drawn to the final reading. One comes from the first reading and is labelled as the average over 5 months, 9.22 a month. One comes from the reading two months back and is labelled as the average over 2 months, 3.45 a month. One comes from the reading one month back and is labelled as the average over 1 month, 2.60 a month. The shorter the span, the smaller the average.

**Must know points for you.**

- Ask "over what interval" every time somebody hands you a rate.
- An average rate over a stretch of time is not the rate now. It is built from the first value and the last value alone.
- Quote a rate with its unit, taken from the quantity divided by the time. Twenty kilograms a month is a claim somebody can check.
- Two quantities can share an average rate and have nothing else in common. Ask for the values in between before you accept that two things are behaving alike.
- A rate you read off a curve by eye is an estimate and not a measurement. It is only as good as the drawing under your ruler.
- Suppose each year's gain has been smaller than the year before. Then the average over the whole programme is higher than the average over any shorter run of whole years ending today. Quoted as the rate now, it flatters the programme.
- When a press line says a quantity is rising at some figure a month, ask which months were used.
- Teach a trainee to write the interval down beside every rate they compute, before the number leaves their page.
...
**7.** A quantity is recorded five times, a month apart: 200, 320, 380, 410, 425.

Work out the average rate of change from the first reading to the last. Then work out the rate over the
