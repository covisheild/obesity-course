# Figure planner brief · S02-R1 (PIPELINE.md "Figure plan")

Repository `/home/claude/obesity-course`, branch `book/S02-R1`. Do not commit. Edit only the records
...
- Run `python check/figures/draw.py --book S02-R1` (it redraws every S02-R1 figure; another planner
...
Scratch in `/home/claude/scratch-fig-<batch>/`. Write `books/S02-R1/FIGURES-<batch>.md`: per
